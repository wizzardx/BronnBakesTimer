...
class DefaultInputValidatorTest {
    ...
    fun setUp() {
        ...
        timerManager =
            DefaultTimerManager(mainTimerRepository, extraTimersCountdownRepository, extraTimersUserInputsRepository)
    ...
    @Test
    fun validatesAllInputsReturnsValidWhenInputsAreValid() =
        runTest {
    ...
    @Test
    fun validatesAllInputsReturnsInvalidWhenMainTimerInputIsInvalid() =
        runTest {
    ...
    @Test
    fun validatesAllInputsReturnsInvalidWhenExtraTimerInputIsInvalid() =
        runTest {
            val timerDurationInput = MutableStateFlow("10")
            val setTimerDurationInputError: (String?) -> Unit = {}

            // Mocking an extra timer with invalid duration input
            val invalidExtraTimerInput =
                ExtraTimerUserInputData().apply {
                    inputs.updateTimerDurationInput("invalid")
                }
            `when`(
                extraTimersUserInputRepository.timerData,
            ).thenReturn(MutableStateFlow(listOf(invalidExtraTimerInput)))
    ...
    @Test
    fun validateAllInputsShouldReturnValidResultWhenAllInputsAreCorrect() =
        runTest {
    ...
    @Test
    fun validateAllInputsClearsExistingErrorMessagesBeforeValidation() =
        runTest {
